...
<body>
    ...
    <form class="login-container" action="adLogin.do" method="post">
        <h2>광고주 로그인</h2>
        ...
        <input type="text" name="amemId" placeholder="아이디" required>
        <input type="password" name="amemPass" placeholder="비밀번호" required>
        ...
        <div class="extra-links">
            <button type="button" onclick="location.href='admemberJoin.do'">회원가입</button>
